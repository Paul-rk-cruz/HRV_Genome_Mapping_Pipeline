...
process Mapping_PE {
    ...
    """
    #!/bin/bash
    bbmap.sh in=${base}.trimmed.fastq.gz outm=${base}_map1.sam ref=${Reference_Fasta} threads=${task.cpus} covstats=${base}_map1_bbmap_out.txt covhist=${base}_map1_histogram.txt maxindel=20 strictmaxindel local=true -Xmx6g > ${base}_map1_stats.txt 2>&1
